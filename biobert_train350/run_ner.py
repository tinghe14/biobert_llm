...
def main():
    ...
    print(f"labels: {labels}, label_map: {label_map}, num_labels: {num_labels}")
    ...
    def compute_metrics(p: EvalPrediction) -> Dict:
        ...
        return {
            ...
            "relaxed_classification_report": classification_report(out_label_list, preds_list, digits=2),
            "strict_classification_report": classification_report(out_label_list, preds_list, mode='strict',digits=2),
        }
